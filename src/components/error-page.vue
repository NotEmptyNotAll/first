    ...
    <div id="error-page">
        ...
        <div class="error-content  " >
            ...
            <div class="container search-border rad">
                <div class="err-logo">
                    <div class="head-text deepshd " style="position:relative ; "><h2>{{$ml.get('errPage.logoText')}}</h2></div>
                </div>
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="error-text">
                            ...
                            <h4>{{$ml.get('errPage.oopsRow')}}</h4>
                            <p>{{$ml.get('errPage.SorryRow')}}</p>
                            <a href="" type="button" class="btn btn-outline-dark shadow-lg">{{$ml.get('errPage.buttonText')}}</a>
